...
#### **Q1: The code below[^doc] simulates samples from the jar with samples of size 3, 10, 100, and 1,000, and displays the results in histograms. Run this code multiple times. Before running this code, what do you predict will happen when sample size increases? After running the code, did you find your hypothesis was true? *Answer here: [Ans: Q1]***
...
samp_dist_new <- samp_dist +
  ...
  labs(title = "Sampling Distribution for Proportions", 
