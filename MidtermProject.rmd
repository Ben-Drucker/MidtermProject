...
<!--If time, explain reason for this standard deviation.-->
...
1.  **Independence:** Each of the observations within a sample must be taken independently.
    It can be very difficult (if not impossible) to verify this assumption. However, we can consider the following 
