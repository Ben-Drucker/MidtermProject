...
[^doc]: `for` loop tutorials from @r_for and @r_for_2; `if`-`else` statement documentation/tutorial from @r_if_else. `sample` documentation/tutorials from @r_sample and @r_SO1, @r_sample_3, @r_sample_4, and @r_sample_2; `colon` operator documentation from @r_colon; `append` documentation from @r_append; for general graph-making on all graphs, the GGplot2 documentation (@gg) was used.
