...
This type of histogram is called a **sampling distribution of proportions**. This is because it is the *distribution* of *samples* for which we are trying to gain information about a population *proportion*.
