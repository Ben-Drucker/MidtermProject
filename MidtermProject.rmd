...
Make sure to run the following code chunk to load in the correct libraries! For each question, the answer with relevant output is included in the "Answers" section.
```{r}
library(tidyverse)
library(tidymodels)
library(patchwork)
...
#### **Q7: The following code shows histograms of marble diameters found in random samples of differing sizes. It also shows the mean of the sample. Try running the code multiple times. Verify that the mean is more stable for samples of larger sizes. *Answer here: [Ans: Q7]***
